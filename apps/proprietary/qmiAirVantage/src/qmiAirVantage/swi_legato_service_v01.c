...
/* This file was generated with Tool version 6.14.9
   It was generated on: Wed Jul 25 2018 (Spin 0)
...
static const uint8_t swi_legato_avms_get_setting_resp_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(swi_legato_avms_get_setting_resp_msg_v01, apn_config) - QMI_IDL_OFFSET8(swi_legato_avms_get_setting_resp_msg_v01, apn_config_valid)),
  0x12,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(swi_legato_avms_get_setting_resp_msg_v01, apn_config),
  QMI_IDL_TYPE88(0, 5),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(swi_legato_avms_get_setting_resp_msg_v01, prompt_reboot) - QMI_IDL_OFFSET8(swi_legato_avms_get_setting_resp_msg_v01, prompt_reboot_valid)),
  0x15,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(swi_legato_avms_get_setting_resp_msg_v01, prompt_reboot)
};
...
static const uint8_t swi_legato_avms_set_setting_req_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(swi_legato_avms_set_setting_req_msg_v01, apn_config) - QMI_IDL_OFFSET8(swi_legato_avms_set_setting_req_msg_v01, apn_config_valid)),
  0x13,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(swi_legato_avms_set_setting_req_msg_v01, apn_config),
  QMI_IDL_TYPE88(0, 5),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(swi_legato_avms_set_setting_req_msg_v01, prompt_reboot) - QMI_IDL_OFFSET8(swi_legato_avms_set_setting_req_msg_v01, prompt_reboot_valid)),
  0x16,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(swi_legato_avms_set_setting_req_msg_v01, prompt_reboot)
};
...
static const qmi_idl_service_message_table_entry swi_legato_service_command_messages_v01[] = {
  ...
  {QMI_SWI_LEGATO_AVMS_SET_SETTINGS_REQ_V01, QMI_IDL_TYPE16(0, 13), 159},
...
static const qmi_idl_service_message_table_entry swi_legato_service_response_messages_v01[] = {
  ...
  {QMI_SWI_LEGATO_AVMS_GET_SETTINGS_RESP_V01, QMI_IDL_TYPE16(0, 12), 173},
