...
typedef struct {
  ...
  /**<   APN Configuration
 Reserved for Notification Storing and Observer Period */

  /* Optional */
  /*  Enable User Prompt for reboot request */
  uint8_t prompt_reboot_valid;  /**< Must be set to true if prompt_reboot is being passed */
  uint8_t prompt_reboot;
  /**<
                                  0x00 ¨C FALSE
                                  0x01 ¨C TRUE
                                  */
